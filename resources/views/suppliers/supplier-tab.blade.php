    ...
    <div class="collapse accordion-content" id="dress_section">
        <div class="">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input id="quantity" type="number" maxlength="5"
                               ...
                               class="form-control required " name="quantity" value="" required=""
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="name"><span class="required_lbl">*</span>{{ __('اسم الفستان او الاكسسوار') }}
                        </label>
                        <select class="js-example-basic-single" name="name">
                            ...
                            <option value="فساتين زفاف البرنسيس" style="background-color: #eeeeee">فساتين زفاف
                                البرنسيس
                            </option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="model"><span class="required_lbl">*</span>{{ __('موديل الفستان او الاكسسوار') }}
                        </label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="price" type="text" class="form-control required @error('model') is-invalid @enderror"
                               ...
                               autocomplete="price" maxlength="5"
                               oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        >
