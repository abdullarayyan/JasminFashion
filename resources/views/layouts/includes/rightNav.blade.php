...
{{--            <li id="general">--}}
{{--                <span>عام--}}
{{--                    <i style="margin: 10px" id="p" class='fas fa-angle-down'></i>--}}
{{--                </span>--}}
{{--            </li>--}}
{{--            <li style="margin: 0" class="hide" id="control_panel">--}}
...
{{--            $("#reservationsub").toggle();--}}

{{--        })--}}
{{--        $('ul').find('.inventory').click(function () {--}}
{{--            $('ul').find('.subInventory').toggle()--}}
{{--        });--}}
