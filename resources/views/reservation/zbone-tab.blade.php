        ...
        <div class="customers_form">
            <form id="add_customer_form" class="custom_form">
                ...
                <div class="form-group">
                    <label for="customer_full_name"><span class="required_lbl">*</span>{{ __('الإسم الرباعي') }}</label>
                    <input id="customer_full_name" type="text"
                           ...
                           autocomplete="customer_full_name">
                ...
                <div class="form-group">
                    <label for="customer_idc"><span class="required_lbl">*</span>{{ __('رقم الجوال') }}</label>
                    <input id="customer_idc" type="number"
                           class="form-control required @error('customer_idc') is-invalid @enderror" name="customer_idc"
                           value="{{ old('customer_idc') }}" autocomplete="customer_idc">
                ...
                <div class="form-group">
                    <label for="customer_nationality">{{ __('المدينة') }}</label>
                    <input id="customer_nationality" type="text"
                           ...
                           autocomplete="customer_nationality">
                ...
                <div class="form-group">
                    <label for="customer_nationality">{{ __('البلدة') }}</label>
                    <input id="customer_nationality" type="text"
                           class="form-control @error('customer_nationality') is-invalid @enderror"
                           name="customer_nationality"
                           value="{{ old('customer_nationality') }}"
                ...
                <div class="form-group">
                    <label for="mother_birth_of_date">{{ __('ابتداء من') }}</label>
                ...
                <div class="form-group">
                    <label for="mother_birth_of_date">{{ __('حتى نهاية') }}</label>
                    <input id="mother_birth_of_date" type="date" name="mother_birth_of_date"
                           class="date datepicker form-control @error('mother_birth_of_date') is-invalid @enderror"
                           value="{{ old('mother_birth_of_date') }}"
                           data-plugin="datepicker">
