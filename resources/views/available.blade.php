...
@section('title', 'طباعة تقرير للمتوفر')
...
<?php
    ...
    $product = \App\Models\Product::query()->where('status',1)->get();
    $party = \App\Models\Party::query()->where('status',1)->get();
    $acc = \App\Models\Accessory::query()->where('status',1)->get();
